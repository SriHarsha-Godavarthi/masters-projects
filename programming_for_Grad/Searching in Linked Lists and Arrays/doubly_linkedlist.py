...
linkedList.traverse()
random_numbers=linkedList.convertToArray()
...
linkedList.head=linkedList.convertArrayToLinkedList(random_numbers)
# linkedList.traverse()
...
#     if greaterThanFifty>5:
#         isAscendingOrder=True
#         linkedList.sortAscendingOrder()
#     else:
#         linkedList.sortDescendingOrder()
# linkedList.traverse()
...
#      randomList.pop(1)
# new_element=int(input("enter new value to insert\n"))
# position=binaryInsertion(randomList,new_element,isAscendingOrder)
# randomList.insert(position,new_element)
